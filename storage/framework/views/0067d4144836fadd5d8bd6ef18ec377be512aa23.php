    ...
    <div class="border border-gray-500 w-1/3 mt-6 mx-auto py-6 px-8 text-center">
        ...
        <form action="/answers/<?php echo e($answer->id); ?>" method="POST">
            ...
            <div class="mb-2">
                ...
                <input type="text" name="text" class="border border-black bg-gray-800 px-2 py-1 outline-none" value="<?php echo e($answer->text); ?>">
            </div>
            <div class="mb-2">
...
<?php /**PATH C:\xampp\Projects\Quiz\resources\views/answers/edit.blade.php ENDPATH**/ ?>